...
import {
  ...
  Int64IgnoreSchema,
  Int64InSchema,
  Int64LTEOptionalSchema,
  Int64LTESchema,
  Int64LTSchema,
  Int64NoneSchema,
  Int64NotInSchema,
  SFixed32ConstSchema,
  SFixed32ExGTELTESchema,
  SFixed32ExLTGTSchema,
  SFixed32GTELTESchema,
  SFixed32GTESchema,
  SFixed32GTLTSchema,
  SFixed32GTSchema,
  SFixed32IgnoreSchema,
  SFixed32InSchema,
  SFixed32LTESchema,
  SFixed32LTSchema,
  SFixed32NoneSchema,
  SFixed32NotInSchema,
  SFixed64ConstSchema,
  SFixed64ExGTELTESchema,
  SFixed64ExLTGTSchema,
  SFixed64GTELTESchema,
  SFixed64GTESchema,
  SFixed64GTLTSchema,
  SFixed64GTSchema,
  SFixed64IgnoreSchema,
  SFixed64InSchema,
  SFixed64LTESchema,
  SFixed64LTSchema,
  SFixed64NoneSchema,
...
it("float - none - valid", () => {
  const message = FloatNone.fromJson({ val: -1.23456 });
  expect(message).toBeValid(FloatNoneSchema);
});

it("float - const - valid", () => {
  const message = FloatConst.fromJson({ val: 1.23 });
  expect(message).toBeValid(FloatConstSchema);
});

it("float - const - invalid", () => {
  const message = FloatConst.fromJson({ val: 4.56 });
  expect(message).toBeInvalid(FloatConstSchema, 1);
});

it("float - in - valid", () => {
  const message = FloatIn.fromJson({ val: 7.89 });
  expect(message).toBeValid(FloatInSchema);
});

it("float - in - invalid", () => {
  const message = FloatIn.fromJson({ val: 10.11 });
