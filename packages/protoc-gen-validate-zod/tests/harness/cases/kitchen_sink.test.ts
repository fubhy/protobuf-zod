...
it("kitchensink - field - valid", () => {
  const message = KitchenSinkMessage.fromJson({"val":{"const":"abcd","intConst":5,"floatVal":1,"durVal":"3s","tsVal":"1970-01-01T00:00:17Z","floatConst":7,"doubleIn":123,"enumConst":"ComplexTWO","anyVal":{"@type":"type.googleapis.com/google.protobuf.Duration","value":"0s"},"repTsVal":["1970-01-01T00:00:03Z"],"mapVal":{"-2":"b","-1":"a"},"bytesVal":"AJk=","x":"foobar"}});
