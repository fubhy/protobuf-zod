...
import {RepeatedAnyIn, RepeatedAnyNotIn, RepeatedDuration, RepeatedEmbedCrossPackageNone, RepeatedEmbeddedEnumIn, RepeatedEmbeddedEnumNotIn, RepeatedEmbedNone, RepeatedEmbedSkip, RepeatedEnumIn, RepeatedEnumNotIn, RepeatedExact, RepeatedExactIgnore, RepeatedItemIn, RepeatedItemNotIn, RepeatedItemPattern, RepeatedItemRule, RepeatedMax, RepeatedMin, RepeatedMinAndItemLen, RepeatedMinAndMaxItemLen, RepeatedMinMax, RepeatedNone, RepeatedUnique} from "./repeated_pb.js";
import {RepeatedAnyInSchema, RepeatedAnyNotInSchema, RepeatedDurationSchema, RepeatedEmbedCrossPackageNoneSchema, RepeatedEmbeddedEnumInSchema, RepeatedEmbeddedEnumNotInSchema, RepeatedEmbedNoneSchema, RepeatedEmbedSkipSchema, RepeatedEnumInSchema, RepeatedEnumNotInSchema, RepeatedExactIgnoreSchema, RepeatedExactSchema, RepeatedItemInSchema, RepeatedItemNotInSchema, RepeatedItemPatternSchema, RepeatedItemRuleSchema, RepeatedMaxSchema, RepeatedMinAndItemLenSchema, RepeatedMinAndMaxItemLenSchema, RepeatedMinMaxSchema, RepeatedMinSchema, RepeatedNoneSchema, RepeatedUniqueSchema} from "./repeated_zod.js";
...
it("repeated - items - invalid (any in)", () => {
  ...
  const message = RepeatedAnyIn.fromJson({"val":[{"value":"1970-01-01T00:00:00Z","@type":"type.googleapis.com/google.protobuf.Timestamp"}]}, { typeRegistry: registry });
  expect(message).toBeInvalid(RepeatedAnyInSchema, 1);
});

it("repeated - items - valid (any in)", () => {
  const registry = createRegistry(Duration);
  const message = RepeatedAnyIn.fromJson({"val":[{"value":"0s","@type":"type.googleapis.com/google.protobuf.Duration"}]}, { typeRegistry: registry });
  expect(message).toBeValid(RepeatedAnyInSchema);
});

it("repeated - items - invalid (any not_in)", () => {
  const registry = createRegistry(Timestamp);
  const message = RepeatedAnyNotIn.fromJson({"val":[{"value":"1970-01-01T00:00:00Z","@type":"type.googleapis.com/google.protobuf.Timestamp"}]}, { typeRegistry: registry });
  expect(message).toBeInvalid(RepeatedAnyNotInSchema, 1);
});

it("repeated - items - valid (any not_in)", () => {
  const registry = createRegistry(Duration);
  const message = RepeatedAnyNotIn.fromJson({"val":[{"value":"0s","@type":"type.googleapis.com/google.protobuf.Duration"}]}, { typeRegistry: registry });
