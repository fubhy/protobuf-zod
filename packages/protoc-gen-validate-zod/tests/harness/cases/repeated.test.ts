...
it("repeated - items - invalid (any in)", () => {
  const message = RepeatedAnyIn.fromJson({"val":[{"@type":"type.googleapis.com/google.protobuf.Timestamp","value":"1970-01-01T00:00:00Z"}]});
  expect(message).toBeInvalid(RepeatedAnyInSchema, 1);
});

it("repeated - items - valid (any in)", () => {
  const message = RepeatedAnyIn.fromJson({"val":[{"@type":"type.googleapis.com/google.protobuf.Duration","value":"0s"}]});
  expect(message).toBeValid(RepeatedAnyInSchema);
});

it("repeated - items - invalid (any not_in)", () => {
  const message = RepeatedAnyNotIn.fromJson({"val":[{"@type":"type.googleapis.com/google.protobuf.Timestamp","value":"1970-01-01T00:00:00Z"}]});
  expect(message).toBeInvalid(RepeatedAnyNotInSchema, 1);
});

it("repeated - items - valid (any not_in)", () => {
  const message = RepeatedAnyNotIn.fromJson({"val":[{"@type":"type.googleapis.com/google.protobuf.Duration","value":"0s"}]});
