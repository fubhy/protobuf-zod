...
import {
  StringAddressSchema,
  StringConstSchema,
  StringContainsSchema,
  StringEmailSchema,
  StringEqualMinMaxBytesSchema,
  StringEqualMinMaxLenSchema,
  StringHostnameSchema,
  StringHttpHeaderNameSchema,
  StringHttpHeaderValueSchema,
  StringInSchema,
  StringIPSchema,
  StringIPv4Schema,
  StringIPv6Schema,
  StringLenBytesSchema,
  StringLenSchema,
  StringMaxBytesSchema,
  StringMaxLenSchema,
  StringMinBytesSchema,
  StringMinLenSchema,
  StringMinMaxBytesSchema,
  StringMinMaxLenSchema,
  StringNoneSchema,
  StringNotContainsSchema,
  StringNotInSchema,
  StringPatternEscapesSchema,
  StringPatternSchema,
  StringPrefixSchema,
  StringSuffixSchema,
  StringURIRefSchema,
  StringURISchema,
  StringUUIDIgnoreSchema,
  StringUUIDSchema,
  StringValidHeaderSchema,
} from "./strings_zod.js";
...
it("string - address - invalid hostname (too long)", () => {
  const message = StringAddress.fromJson({
...
it("string - hostname - invalid (too long)", () => {
  const message = StringHostname.fromJson({
    val: "x0123456789012345678901234567890123456789012345678901234567890123456789.com",
  });
  expect(message).toBeInvalid(StringHostnameSchema, 1);
});
